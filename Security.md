...
![Settings for app downloads: 'App Store' or 'App Store and identified developers' selected.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_allowed_apps.jpg)
...
MacOS is built to be secure by design, which is why many security settings and configurations are enabled by default. Let's go through some of the main security features available in macOS and how we can configure them.
...
|<= macOS 12|>= mac13|
|---|---|
|![Privacy settings window showing Files and Folders access for Terminal and Visual Studio Code, with checkboxes for Downloads, Documents, and Desktop folders.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_privacy_settings.jpg)|![Privacy & Security settings window showing options for Location Services, Contacts, and Calendars under Privacy.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_security_privacy_ventura.jpg)|
...
![FileVault settings window with a description of automatic disk encryption and a warning about needing a login password or recovery key to access data.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_filevault.jpg)
...
|<= macOS 12|>= mac13|
|---|---|
|![Security settings with options checked for allowing built-in and signed software to receive connections, and enabling stealth mode.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_firewall_settings.jpg)|![Network settings showing Wi-Fi connected, Firewall active, iPhone USB not connected, and Thunderbolt Bridge inactive.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/networking-ventura.jpg)|
...
In recent macOS releases, Keychain also allows us to store our two-factor authentication (2FA) keys with our passwords. It can automatically fill in the code when logging into the app, which makes it very convenient to be secure by enabling 2FA without any extra complications:![Password manager window showing entry for academy.hackthebox.com with username 21y4d and a verification code section.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_passwords.jpg)
...
![Find My Mac settings with options on for locating, locking, or erasing the Mac, and participating in the Find My network.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_find_my_mac.jpg)
...
![Private Relay settings with Private Relay off, description of privacy features, and a note about potential website access issues without IP address.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_private_relay.jpg)
...
![Hide My Email settings for Adobe, showing a created email address with forwarding enabled.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_hide_my_email.jpg)
...
![Advanced Data Protection settings with iCloud encryption details and a list of data types like Device Backup, Messages Backup, and Photos.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_advanced_data_protection.jpg)
...
![Lockdown Mode settings with a description of its extreme protection features and impact on Mac functionality.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/macos_lockdown_mode.jpg)
...
![KnockKnock app interface showing categories like Login Items and Quicklook Plugins, with items such as ReiKey Helper and 1Password Extension Helper listed.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/kk.png)
...
![NetIQette app interface showing network connections for Adobe Desktop Service, Core Sync, VMware Fusion, and WhatsApp with details on protocol, interface, and state.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/157/netiquette.png)
